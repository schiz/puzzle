...
if ($_REQUEST["action"] == 'getkey') {
    ...
    if(!$isAuthorized) { //сменил $USER->IsAuthorized() на $isAuthorized

        print json_encode(array('res'=>0, 'message'=>'Вам надо авторизоваться', 'data'=>'/auth/404?testparam'));
